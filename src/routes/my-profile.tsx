            ...
            <Card className="border-border/60" style={{ boxShadow: "var(--shadow-card)" }}>
              <CardContent className="p-6">
                ...
                <p className="mb-3 text-xs text-muted-foreground">
                  Barcha test natijalari yig'indisi
                </p>
                <div className="h-72">
            ...
            <CardContent className="p-6">
              ...
              <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
                {topCareers.slice(0, 6).map((c, i) => (
                  <div
                    key={c.id}
                    className="group rounded-xl border border-border/50 p-4 transition-all hover:border-primary/40 hover:shadow-md"
                  >
                    <div className="flex items-start justify-between gap-2 mb-2">
                      ...
                      <h4 className="flex-1 font-semibold text-foreground group-hover:text-primary text-sm">
                        {c.name_uz}
                      </h4>
                    </div>
                    {c.description && (
                ...
                {universities.map((u, i) => (
                  <div key={u.name} className="rounded-xl border border-border/50 p-4">
                    <div className="flex items-start justify-between gap-2">
                      <span className="flex h-7 w-7 items-center justify-center rounded-full bg-secondary/10 text-xs font-bold text-secondary shrink-0">
                        #{i + 1}
                      </span>
            ...
            {aiSummary ? (
              ...
              <div className="rounded-xl border border-dashed border-border p-6 text-center">
                ...
                <p className="text-xs text-muted-foreground mb-4">
                  Sun'iy intellekt barcha test natijalaringizni tahlil qilib, shaxsiy xarakter,
                  kuchli tomonlar va kelajak uchun yo'l xaritasini tuzadi.
          ...
          <Card className="border-dashed">
            <CardContent className="flex flex-col items-center justify-center gap-3 p-12 text-center">
              ...
              <p className="max-w-sm text-sm text-muted-foreground">
                Testlarni yakunlang — natijalar avtomatik ravishda portfolionga qo'shiladi va
                psixologik profilingiz shakllanadi.
              </p>
